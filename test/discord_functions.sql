...
BEGIN
	...
	RETURN NEXT lives_ok($sql$SELECT discord.WalletChange(10, null) FOR UPDATE;$sql$, 'Reason.');
	-- input: 0, 10 output: The function should create a Wallet for user id 0.
	RETURN NEXT lives_ok($sql$SELECT discord.WalletChange(10, 0) FOR UPDATE;$sql$, 'Reason.');
	...
	RETURN NEXT lives_ok($sql$SELECT discord.WalletChange(-5, 0) FOR UPDATE;$sql$, 'Reason.');
	...
	RETURN NEXT lives_ok($sql$SELECT discord.WalletChange(1000000000, 0) FOR UPDATE;$sql$, 'Reason.');
	...
	RETURN NEXT lives_ok($sql$SELECT discord.WalletChange(1, 0) FOR UPDATE;$sql$, 'Reason.');
	RETURN NEXT results_eq($sql$SELECT discord.WalletGet(0);$sql$, $sql$SELECT 1000000000;$sql$, 'Reason.');
	-- input: 0, -1000000001 output: User id 0 should have 0 bits.
	RETURN NEXT lives_ok($sql$SELECT discord.WalletChange(-1000000001, 0) FOR UPDATE;$sql$, 'Reason.');
	RETURN NEXT results_eq($sql$SELECT discord.WalletGet(0);$sql$, $sql$SELECT 0;$sql$, 'Reason.');
	...
	RETURN NEXT throws_ok($sql$SELECT discord.WalletTransfer(10, 1, 0);$sql$, 'P0001', 'No funds available.', 'Reason.');
	-- input: Give 0, 10 bits. 0, 1, 10 output: User id 1 should have 8 bits (20% fee, rounded up).
	RETURN NEXT lives_ok($sql$SELECT discord.WalletChange(10, 0) FOR UPDATE;$sql$, 'Reason.');
	RETURN NEXT lives_ok($sql$SELECT discord.WalletTransfer(10, 0, 1) FOR UPDATE;$sql$, 'Reason.');
	...
	RETURN NEXT throws_ok($sql$SELECT discord.WalletTransfer(10, 0, 1);$sql$, 'P0001', 'Not enough funds available.', 'Reason.');
	-- input: 1, 0, 10 output: User 0 should have 7 bits.
	RETURN NEXT lives_ok($sql$SELECT discord.WalletTransfer(10, 1, 0) FOR UPDATE;$sql$, 'Reason.');
	...
	RETURN NEXT throws_ok($sql$SELECT discord.WalletTransfer(-10, 0, 1);$sql$, 'P0001', 'Can''t transfer back.', 'Reason.');
	-- input: null, 1, 10
	RETURN NEXT lives_ok($sql$SELECT discord.WalletTransfer(10, null, 1) FOR UPDATE;$sql$, 'Reason.');
	RETURN NEXT results_eq($sql$SELECT discord.WalletGet(1);$sql$, $sql$SELECT 7;$sql$, 'Reason.');
	-- Should transfer to bank.
	RETURN NEXT lives_ok($sql$SELECT discord.WalletTransfer(7, 1, null) FOR UPDATE;$sql$, 'Reason.');
